                ...
                <div id="2" className="flex justify-around grow-1">
                    <div className="flex">
                        <ul className="self-end">
                            <li className="text-sm">Min <span>{data.minTemperature.toFixed()}</span> ºC</li>
                            <li className="text-sm">Max <span>{data.maxTemperature.toFixed()}</span> ºC</li>
                        </ul>
                    </div>
                    <div className="text-end">
                        <h2 className="text-xl">Sunday</h2>
                        <h3 className="text-4xl font-bold text-gray-600">{data.temperature.toFixed()} ºC</h3>
