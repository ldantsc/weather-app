...
export default function Weather(props: any) {
    ...
    return (
        <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} transition={{ delay: 1, duration: 0.6 }} id="container-weather" className="flex justify-center items-center h-full scale-85 md:scale-100  transform-gpu">
            <div id="weather" className="flex flex-col justify-around xl:w-[350px] xl:h-[350px] lg:w-[300px] lg:h-[300px] md:w-[280px] md:h-[280px] w-[270px] h-[270px] m-2 px-5 xl:m-3 xl:px-8 xl:py-5 py-3 rounded-3xl">
                ...
                <div id="container-weather-bottom-info" className="flex justify-between p-2">
                    <div id="container-temperatures-min-max" className="flex">
                    ...
                    <div id="container-weather-main" className="text-end">
